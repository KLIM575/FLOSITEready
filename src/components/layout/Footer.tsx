        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white font-serif">Flower Shop</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Создаём неповторимые букеты для ваших особенных моментов с 2020 года.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                ...
                <a href="tel:+79001234567" className="text-sm hover:text-primary-400 transition-colors">
                  +7 (900) 123-45-67
                </a>
              </li>
              <li className="flex items-start space-x-2">
                ...
                <a href="mailto:info@flowershop.ru" className="text-sm hover:text-primary-400 transition-colors">
                  info@flowershop.ru
                </a>
              </li>
              <li className="flex items-start space-x-2">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              &copy; {currentYear} Flower Shop. Все права защищены.
            </p>
